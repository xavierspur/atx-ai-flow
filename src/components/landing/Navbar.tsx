    ...
    <nav className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
      <div className="container-narrow mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-foreground">ATXDOES AI</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link to="/onboarding">
            <Button size="sm">Get Instant Access</Button>
          </Link>
        </div>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-border bg-background px-4 py-4 space-y-3">
          ...
          <div className="pt-3 space-y-2">
            ...
            <Link to="/onboarding"><Button className="w-full" size="sm">Get Instant Access</Button></Link>
          </div>
        </div>
      )}
    </nav>
